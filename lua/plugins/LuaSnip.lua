...
--       --   {}
--       -- )
--       -- keymap("i", "<C-h>", function() ls.jump(-1) end, {})
--       -- keymap({ "i", "s" }, "<C-l>", function() ls.jump(1) end, {})
--       -- keymap({ "i", "s" }, "<c-j>", "<Plug>luasnip-next-choice", {})
--       -- keymap({ "i", "s" }, "<c-k>", "<Plug>luasnip-prev-choice", {})
--       -- keymap(
--       --   "n",
--       --   "<Leader>U",
--       --   '<Cmd>echo "Snippets refreshed!"<CR><Cmd>source ~/.config/nvim/lua/plugins/default/luasnip.lua<CR>'
--       -- )
--       -- {
--       --   "<tab>",
--       --   function()
